...
PERSONAL_USE_SCRIPT_14_CHARS = "lA_oT2laMdHkrA"
SECRET_KEY_27_CHARS = "4YJG1U_iO9mELSu5IDBpXHc0rQU"
YOUR_APP_NAME = "RedditCommentScraper"
YOUR_REDDIT_USER_NAME = "PapaCraken"
YOUR_REDDIT_LOGIN_PASSWORD = "Abracadabra42"
...
for subreddit_name in subreddit_list:
    ...
    for submission in scraped:
        ...
        for top_level_comment in submission.comments:
            ...
            #f.write("\nScore: " + str(top_level_comment.score) + " - u/" + top_level_comment.author.name)
            f.write("\n---------\n")
